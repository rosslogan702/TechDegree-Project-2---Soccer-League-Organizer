...
public class Player implements Comparable<Player>, Serializable {
  ...
  public int compareTo(Player other) {
    ...
    int playerLastNameCompare = lastName.compareTo(player.lastName);
    if(playerLastNameCompare == 0){
     int playerFirstNameCompare = firstName.compareTo(player.firstName);
     return playerFirstNameCompare;
    }
